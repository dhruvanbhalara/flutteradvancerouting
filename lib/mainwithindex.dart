...
class MainScreenState extends State<MainScreen> {
  ...
  void _onPageChanged(int page) {
    ...
    setState(() => _page = page);
    _pageKeys[_page].currentState.onPageVisible(_page);
...
class _PageOneState extends State<PageOne> with MainPageStateMixin {
  @override
  void onPageVisible(int index) {
    print('_PageOneState onPageVisible $index');
  }
...
class _PageTwoState extends State<PageTwo> with MainPageStateMixin {
  @override
  void onPageVisible(int index) {
    print('_PageTwoState onPageVisible $index');
  }
...
class _PageThreeState extends State<PageThree> with MainPageStateMixin {
  @override
  void onPageVisible(int index) {
    print('_PageThreeState onPageVisible $index');
  }
